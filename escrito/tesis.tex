...
Al analizar el estado del arte, se puede observar que las heurísticas evolutivas han jugado un papel esencial para obtener las reglas con las cuales se opera en el mercado. Además, los atributos utilizados en la mayoría de los trabajos son un conjunto de indicadores técnicos (ver sección \ref{subseccion:indicadores tecnicos}).
...
\section{Supuestos para operar en el mercado}
