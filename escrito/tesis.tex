...
Finalmente, observemos que sólo en un caso obtuvimos una ganancia monetaria promedio negativa (algoritmo CN2 experimento AI-DI, tabla \ref{tabla:CN2-NAFTRAC}), en el resto de los experimentos, aún cuando no vencemos a la estrategia \buyhold, en promedio, no perdemos dinero, una características claramente deseable.
