...
El primero de los métodos de discretización (al cual denotaremos como DI), se basa en crear intervalos con el mismo tamaño, sin importar la distribución de los valores de cada atributo; por otro lado, el segundo método (denotado como DC) está basado en los cuantiles de la distribución de los datos de cada atributo, así este método crea intervalos con la misma probabilidad.
...
\hline
\end{tabular}
\caption{\label{tabla:AQ-SP500} Resultados del algoritmo AQ para SPDR S\&P 500}
\end{table}
\end{center}
...
\hline
\end{tabular}
\caption{\label{tabla:CN2-SP500}Resultados del algoritmo CN2 para SPDR S\&P 500}
\end{table}
\end{center}
...
Ganancia monetaria promedio & $\$$ & $\$$ & $\$$ & $\$$ \\
\hline
\end{tabular}
\caption{\label{tabla:AQ-NAFTRAC} Resultados del algoritmo AQ para NAFTRAC}
\end{table}
\end{center}
